...
//     if (stopped) return;
//     try {
//       const data = await fetchOdptTrains(consumerKey);
//       useTrainsRealtimeStore.getState().updateFromFeed(data);
//     } catch (err) {
//       console.warn("[odpt-trains] poll failed:", err);
//     }
//   };
